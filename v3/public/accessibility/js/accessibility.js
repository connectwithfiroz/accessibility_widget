...
var widgetSection = `<audio id="googleTextSpeecher"></audio>
<div
   class="nac light-theme gradient-head accessability-initial custom_widget"
   id="main_w_container"
>
   <div id="widget_header">
      <div class="relative second-panel">
         <div
            class="accessability-reset accessability-f_item widget_header"
            title="Reset accessability features."
            id="reset-all"
            onclick="resetAll()"
         >
            <svg
         ...
         <h3>Accessibility</h3>
         <div
            class="accessability-close accessability-f_item"
            title="Close accessability features."
            onclick="closeMain()"
         ></div>
      </div>
   </div>
   <div class="accessability-body" id="widget_body">
      <div class="h-scroll">
         <div class="row p-0 m-0 slider_main_section"></div>
         <div class="gvc_ffeature">
            <div
               class="accessability-f_item reset-feature"
               id="featureItem-zoom"
               title="Increase or Decrease Zoom Level."
            >
               <button
                  id=""
                  class="accessability-f_item__i"
                  data-reader-content="Enable the UserWay screen reader"
                  aria-label="Enable the UserWay screen reader"
                  aria-pressed="false"
               >
                  <span class="accessability-f_item__icon"
                     ><span class="waf-icon icon-zoom-control"> </span
                  ></span>
                  <div
                     class="accessability-f_item__name inline_ranger_container"
                  >
                     <div class="slider-container">
                        <label for="zoom_ranger" class="slider-label left"
                           >Small</label
                        ><label for="zoom_ranger" class="slider-label middle"
                           >Normal</label
                        ><label for="zoom_ranger" class="slider-label right"
                           >Large</label
                        ><input
                           type="range"
                           class="custom-range"
                  ...
                  <span
                     class="tick-active accessability-f_item__enabled reset-tick"
                     id="tickIcon-zoom"
                     style="top: -5px; right: 0; display: none"
                  >
                  </span>
               </button>
            </div>
            <div
               class="accessability-f_item reset-feature"
               id="featureItem-font_size"
               title="Increase or Decrease Font size."
            >
               <button
                  id=""
                  class="accessability-f_item__i"
               ...
               >
                  ...
                  >
                     <div class="slider-container">
                        <label for="font_size_ranger" class="slider-label left"
                           >Small</label
                        ><label
                           for="font_size_ranger"
                           class="slider-label middle"
                           >Normal</label
                        ><label
                           for="font_size_ranger"
            ...
            <div
               class="accessability-f_item reset-feature"
               id="featureItem-line_height"
               title="Increase or Decrease line height."
            >
               <button
                  id=""
                  class="accessability-f_item__i"
            ...
            <div
               class="accessability-f_item reset-feature"
               id="featureItem-text_space"
               title="Increase or Decrease text space."
            >
               <button
                  id=""
                  class="accessability-f_item__i"
               ...
               >
                  ...
                  >
                     <div class="slider-container">
                        <label for="text_space_ranger" class="slider-label left"
                           >Normal</label
                        ><label
                           for="text_space_ranger"
                           class="slider-label middle"
                           >Medium</label
                        ><label
                           for="text_space_ranger"
            ...
            <div
               class="accessability-f_item reset-feature d-none"
               id="featureItem-lh"
               title="Increase of Decrease line height."
            >
               <button
                  id="btn-s12"
                  class="accessability-f_item__i"
               ...
               >
                  <span class="accessability-f_item__icon"
                     ><span class="waf-icon icon-line-hight"> </span></span
                  ><span class="accessability-f_item__name">Line Height</span>
                  <div
                     class="accessability-f_item__steps reset-steps"
                     id="featureSteps-lh"
                  >
                  </div>
                  <span
            ...
            <div
               class="accessability-f_item reset-feature d-none"
               id="featureItem-ts"
               title="Increase or Decrease text spacing."
            >
               <button
                  id="btn-s13"
               ...
               >
                  <span class="accessability-f_item__icon"
                     ><span class="waf-icon icon-text-spacing"> </span
                  ></span>
                  <span class="accessability-f_item__name">Text Spacing</span>
                  <div
                     class="accessability-f_item__steps reset-steps"
                     id="featureSteps-ts"
                  >
            ...
            <div class="row">
               <div class="col" id="slideUpDown">
                  <div class="accessability-f_item reset-feature">
                     <button
                        id="scrollUpBtn"
                        class="accessability-f_item__i speakIt"
                     ...
                     >
                        <span class="accessability-f_item__icon"
                           ...
                           <span class="accessability-f_item__name"
                              >Scroll Up</span
                           ></span
                        ><span
                           class="tick-active accessability-f_item__enabled reset-tick"
            ...
            <div class="row">
               <div
                  class="col accessability-f_item reset-feature"
                  id="featureItem-ht-dark"
                  title="Enable or Disable, light or Dark Mode."
               >
                  <button
                     id="dark-btn"
                     title="Enable or Disable, light or Dark Mode."
                  ...
                  >
                     <span class="accessability-f_item__name"
                        ><span class="light_dark_icon"
                           ><input
                              type="checkbox"
                              class="light_mode accessability-featugres__item__i"
                              id="checkbox" />
               ...
               >
                  ...
                  >
                     <span class="accessability-f_item__icon">
                        <span class="waf-icon icon-invert"> </span> </span
                     ><span class="accessability-f_item__name"
                        >Invert Colors</span
                     >
                     <span
            ...
            <div class="row">
               <div class="col">
                  ...
                  >
                     ...
                     >
                        <span class="accessability-f_item__icon"
                           ><span class="waf-icon icon-hide-images">
                           </span></span
                        ><span class="accessability-f_item__name"
                           >Hide Images</span
                        >
               ...
               <div class="col">
                  ...
                  >
                     ...
                     >
                        <span class="accessability-f_item__icon">
                           <span class="waf-icon icon-cursor"> </span> </span
                        ><span class="accessability-f_item__name">Cursor</span>
                        <span
                           class="tick-active accessability-f_item__enabled reset-tick"
                           id="tickIcon-cursor"
                           style="display: none"
            ...
            <div
               class="accessability-f_item reset-feature"
               id="featureItem_sp"
               title="Enable or Disable Screen reader."
            >
               <button
                  id="speak"
                  class="accessability-f_item__i"
               ...
               >
                  <span class="accessability-f_item__icon">
                     <span class="waf-icon icon-speaker"> </span> </span
                  ><span class="accessability-f_item__name">Screen Reader</span>
                  <span
                     class="tick-active accessability-f_item__enabled reset-tick"
                     id="tickIcon_sp"
                     style="display: none"
            ...
            >
               ...
               >
                  <span class="accessability-f_item__icon"
                     ><span class="waf-icon icon-bigger-text"> </span></span
                  ><span class="accessability-f_item__name">Bigger Text</span>
                  <div
                     class="accessability-f_item__steps reset-steps"
                     id="featureSteps"
                  >
            ...
            >
               ...
               >
                  <span class="accessability-f_item__icon"
                     ><span class="waf-icon icon-small-text"> </span></span
                  ><span class="accessability-f_item__name">Small Text</span>
                  <div
                     class="accessability-f_item__steps reset-steps"
                     id="featureSteps-st"
                  >
            ...
            <div
               class="accessability-f_item reset-feature"
               id="featureItem-df"
               title="Dyslexia Friendly feature."
            >
               <button
                  id="btn-df"
...
function handleFontSizes(
    ...
    if (FontSizeBtnState) {
      ...
      for (var i = 0; i < 4; i++) {
        StoragestepsHTML +=
          ...
          (i < FontSizeClickState
            ? "active step accessability-features__step"
            : "step accessability-features__step") +
          '"></span>';
      }
      ...
      if (FontSizeStateBigger != 0) {
        ...
        var elements = document.querySelectorAll(
          "*:not(.widget-custom-trigger, .widget-custom-trigger span)",
        );
        elements.forEach(function (element) {
          ...
          if (!isExcludedElement(element)) {
            ...
            var newSize =
              parseFloat(currentSize) + parseFloat(FontSizeStateBigger);
      ...
      if (FontSizeStateSmaller != 0) {
        ...
        elements.forEach(function (element) {
          ...
          if (!isExcludedElement(element)) {
            var currentSize = window.getComputedStyle(element).fontSize;
            var newSize =
              parseFloat(currentSize) - parseFloat(FontSizeStateSmaller);
            element.style.setProperty("font-size", newSize + "px", "important");
          }
        });
      }
  ...
  document.getElementById(btnId).addEventListener("click", function () {
    ...
    document
      ...
      .setAttribute("data-reader-content", clickCount);
...
function adjustFontSizes(increase, btn, addsize, additional_params = {}) {
  let font_steps =
    additional_params && additional_params.font_steps !== undefined
      ? additional_params.font_steps
      : 1;
  ...
  elements.forEach(function (element) {
    ...
    if (!isExcludedElement(element)) {
      var currentSize = window.getComputedStyle(element).fontSize;
      var newSize = increase
        ? parseFloat(currentSize) + font_steps * 1
        : parseFloat(currentSize) - font_steps * 1;
...
function toggleImages() {
  ...
  document.documentElement.id = document.documentElement.classList.contains(
    "image-hide",
  )
    ? "imageHideBg"
    : "";
  ...
  tickIcon_ht.style.display =
    tickIcon_ht.style.display === "none" ? "inline-block" : "none";
  ...
  localStorage.setItem(
    ...
    JSON.stringify(imageVisibilityState),
  );
}
...
function toggleCursorFeature() {
  ...
  tickIcon_cursor.style.display =
    tickIcon_cursor.style.display === "none" ? "inline-block" : "none";
  ...
  localStorage.setItem(
    "cursorFeatureActive",
    featureItem.classList.contains("feature-active"),
  );
}
...
function toggleFontFeature() {
  ...
  tickIcon_df.style.display =
    tickIcon_df.style.display === "none" ? "inline-block" : "none";
  ...
  localStorage.setItem(
    "dyslexia",
    document.documentElement.classList.contains("waf-font-df"),
  );
}
...
function resetAll() {
  let reloadConfirmation =
    1 ||
    window.confirm(
      "Reset to default mode, We need to reload the page. would you like to continue?",
    );
  if (reloadConfirmation) {
    ...
    localStorage.setItem(
      "imageVisibilityState",
      JSON.stringify(resetImageVisibilityState),
    );
...
function googleTextToSpeech(params) {
  ...
  fetch(
    `${AC_SCRIPT_DIR}${atob("L2NvbnRyb2xsZXIvR29vZ2xlVGV4dFRvU3BlZWNoQ29udHJvbGxlci5waHA=")}`,
    {
      method: "POST",
      headers: {
...
function scrollUp() {
  ...
  scrollUpTickIcon.style.display =
    scrollUpTickIcon.style.display == "inline-block" ? "none" : "inline-block";
...
function init(params) {
  ...
  if (localStorageClickCount != null) {
    let fontSizeRangerContainer = document.getElementById(
      "featureItem-font_size",
    );
    ...
    if (localStorageClickCount != "false" && localStorageClickCount != 0) {
      ...
      adjustFontSizes(true, "bt", fontRangerValue, {
        font_steps: fontRangerValue,
      });
  ...
  if (
    localStorageLHClickCount != null &&
    localStorageLHClickCount != "false" &&
    localStorageLHClickCount != 0
  ) {
    setLineHeight(localStorageLHClickCount);
    document.getElementById("line_height_ranger").value =
      localStorageLHClickCount;
  }
  //--------------<<< SET OLD LINE HEIGHT STATUS --------------//
  ...
  if (localStorageTSClickCount != null && localStorageTSClickCount != 0) {
    ...
    document.getElementById("text_space_ranger").value =
      localStorageTSClickCount;
  }
  //--------------<<< SET OLD TEXT SPACING STATUS --------------//
  ...
  var featureItems = document.querySelectorAll(
    ".accessability-f_item, .speakIt",
  );
  ...
  // Restore tickIcon visibility
  var imageVisibilityState = JSON.parse(
    localStorage.getItem("imageVisibilityState"),
  );
  ...
  var GetHighlightLinkState = JSON.parse(
    localStorage.getItem("highlightLinks"),
  );
  ...
  document.getElementById("btn-s12").addEventListener("click", function () {
    ...
    // Update data-reader-content attribute
    document
      .getElementById("btn-s12")
      .setAttribute("data-reader-content", clickCount_lh);
    // Add step span tags dynamically
    var stepsHTML_lh = "";
    for (var i = 0; i < 3; i++) {
      stepsHTML_lh +=
  ...
  document.getElementById("btn-invert").addEventListener("click", function () {
    ...
    // Toggle the tick icon
    var tickIcon_ic = document.getElementById("tickIcon-ic");
    tickIcon_ic.style.display =
      tickIcon_ic.style.display === "none" ? "inline-block" : "none";
    ...
    localStorage.setItem(
      "invertFeature",
      document.documentElement.classList.contains("waf-bg-white"),
    );
  });

  document
    .getElementById("font_size_ranger")
    .addEventListener("change", function () {
      ...
      if (clickCount == 0) {
        ...
        document
          .getElementById("featureItem-font_size")
        ...
        document.getElementById("tickIcon-font_size").style.display =
          "inline-block";
      }
  ...
  function setLineHeight(currentValue) {
    ...
    if (clickCount == 0) {
      ...
      //AGAR VALUE = 0 THEN REMOVE ACTIVE FROM LABEL
      document
        .getElementById("featureItem-line_height")
        .classList.remove("feature-active");
      ...
      document
        .getElementById("featureItem-line_height")
        .classList.add("feature-active");
      document.getElementById("tickIcon-line_height").style.display =
        "inline-block";
  ...
  document
    .getElementById("line_height_ranger")
    .addEventListener("change", function () {
      let currentValue = this.value;
  ...
  function setLetterSpacing(currentValue) {
    ...
    if (clickCount == 0) {
      //AGAR VALUE = 0 THEN REMOVE ACTIVE FROM LABEL
      document
        .getElementById("featureItem-text_space")
        .classList.remove("feature-active");
      ...
      document
        .getElementById("featureItem-text_space")
        .classList.add("feature-active");
      document.getElementById("tickIcon-text_space").style.display =
        "inline-block";
      const elements = document.querySelectorAll(
        "*:not(.widget-custom-trigger, .widget-custom-trigger span)",
      ); // Select all elements except buttons
  ...
  document
    .getElementById("text_space_ranger")
    .addEventListener("change", function () {
      let currentValue = this.value;
  ...
  document
    ...
    .addEventListener("change", function () {
      ...
      if (clickCount == 0) {
        //AGAR VALUE = 0 THEN REMOVE ACTIVE FROM LABEL
        document
          .getElementById("featureItem-zoom")
          .classList.remove("feature-active");
  ...
  document
    .getElementById("widget-custom-trigger")
    .addEventListener("click", function () {
  ...
  document.getElementById("speak").addEventListener("click", function () {
    // Toggle the tick icon
    var tickIcon_sp = document.getElementById("tickIcon_sp");
    tickIcon_sp.style.display =
      tickIcon_sp.style.display === "none" ? "inline-block" : "none";
    ...
    localStorage.setItem(
      "speak",
      featureItem_sp.classList.contains("feature-active"),
    );
  });
...
function addAccessabilityHTML(params) {
  return new Promise((resolve) => {
    ...
    if (params.accessabilityBtnContainer) {
      const btnLocation = document.getElementById(
        params.accessabilityBtnContainer,
      );
      if (!btnLocation) {
