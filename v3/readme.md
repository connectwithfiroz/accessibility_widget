...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="public/accessibility/css/accessibility-style.css" />
  </head>
  <body>
    ...
    <script src="public/accessibility/js/accessibility.js"></script>

    <!-- 3. Widget Configuration & Auto-Initialization -->
    <script class="erasableJsSrc" src="public/accessibility_config.js"></script>

    <!-- 4. Draggable Module -->
    <script class="erasableJsSrc" type="module" src="public/draggable/draggable.js"></script>
  </body>
</html>