export class FDraggable {
    constructor(params) {
        ...
        if (this.element) {
            ...
            console.error('Invalid element ID passed');
        }
        ...
        if (this.elementHeader) {
            ...
            console.error('Invalid element ID Header passed. If elementName is - myElement then must be a header inside with name - myElementHeader');
        }
